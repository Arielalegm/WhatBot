...
export class MessageHistory {
    ...
    setLastMessage(userId: string, message: string) {
        this.lastMessages.set(userId, message);
    }

    getLastMessage(userId: string): string | undefined {
        return this.lastMessages.get(userId);
    }

    clearLastMessage(userId: string) {
